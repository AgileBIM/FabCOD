...
{
    public class CONSTANT : FabNamedObject, IValueType
    {   
        public override ParseType Type => ParseType.CONSTANT;
        ...
        public CONSTANT(ref int i, IList<string> lines, DOCUMENTATION doc)
        {
            ...
            Returns = parts[1]?
                ...
                .Select(p => $"{p.ToUpper()}{suffix}").ToArray();
        }
